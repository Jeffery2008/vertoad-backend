    ...
    public function all(): array
    {
        return array_map(
            ...
            [
                ...
                ['billing.withdrawal.read.own', 'View own organization withdrawal history and payment state.', true],
                ...
                ['billing.withdrawal.payment_proof.platform', 'Upload and verify platform payment proofs for approved withdrawals.', true],
                ...
                ['creative.template.read.own', 'View platform and own organization creative templates.', false],
                ['creative.template.write.own', 'Create or update own organization creative templates.', false],
                ['creative.template.manage.platform', 'Create or update platform creative templates.', true],
                ['creative.design.read.own', 'View own organization creative designs and version history.', false],
                ['creative.design.write.own', 'Create own organization creative designs and versions.', false],
