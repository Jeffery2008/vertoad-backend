...
final class SensitiveRoutePermissionContractTest extends TestCase
{
    ...
    private function routePermissions(): array
    {
        return [
            ...
            ['GET', '/api/v1/billing/withdrawals/own', 'billing.withdrawal.read.own', 'permission'],
            ...
            ['POST', '/api/v1/billing/withdrawals/{withdrawal_id}/approve', 'billing.withdrawal.review.platform', 'platformPermission'],
            ...
            ['GET', '/api/v1/billing/withdrawals/{withdrawal_id}/proofs', 'billing.withdrawal.payment_proof.platform', 'platformPermission'],
            ['POST', '/api/v1/billing/withdrawals/{withdrawal_id}/proofs', 'billing.withdrawal.payment_proof.platform', 'platformPermission'],
            ['POST', '/api/v1/billing/withdrawals/{withdrawal_id}/proofs/confirm', 'billing.withdrawal.payment_proof.platform', 'platformPermission'],
            ['GET', '/api/v1/organizations/{organization_id}/members', 'organizations.members.read', 'permission'],
            ['POST', '/api/v1/organizations/{organization_id}/members', 'organizations.members.manage', 'permission'],
            ['PATCH', '/api/v1/organizations/{organization_id}/members/{member_id}', 'organizations.members.manage', 'permission'],
            ['DELETE', '/api/v1/organizations/{organization_id}/members/{member_id}', 'organizations.members.manage', 'permission'],
            ...
            ['GET', '/api/v1/operations/backups', 'ops.backup.read.platform', 'platformPermission'],
            ['POST', '/api/v1/operations/backups', 'ops.backup.create.platform', 'platformPermission'],
            ['GET', '/api/v1/operations/backups/{job_id}', 'ops.backup.read.platform', 'platformPermission'],
            ['POST', '/api/v1/operations/backups/{job_id}/restore', 'ops.backup.restore.platform', 'platformPermission'],
            ['GET', '/api/v1/operations/errors', 'ops.error_log.read_redacted.platform', 'platformPermission'],
            ['GET', '/api/v1/operations/request-correlations', 'ops.dashboard.read.platform', 'platformPermission'],
            ['GET', '/api/v1/operations/request-correlations/{request_id}', 'ops.error_log.read_redacted.platform', 'platformPermission'],
            ['GET', '/api/v1/operations/errors/{error_id}/raw-context', 'ops.error_log.view_raw.platform', 'platformPermission'],
            ['POST', '/api/v1/operations/ip-geo/lookup', 'ops.error_log.read_redacted.platform', 'platformPermission'],
