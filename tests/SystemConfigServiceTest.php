...
final class SystemConfigServiceTest extends TestCase
{
    ...
    public function testIpGeoProviderPolicyFallsBackToDisabledLocalRegistry(): void
    {
        $policy = (new SystemConfigService(new ArraySystemConfigRepository()))->ipGeoProviderPolicy();
    ...
    public function testIpGeoProviderPolicyRejectsLegacyFlatConfiguredValues(): void
    {
        ...
        try {
            $service->ipGeoProviderPolicy();
            self::fail('Legacy flat serving.geo_provider value must be rejected.');
        } catch (\UnexpectedValueException $exception) {
